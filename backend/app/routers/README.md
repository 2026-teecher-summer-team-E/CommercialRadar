...
| `interest_districts.py` | `/api` | `GET /api/interest-districts`, `POST /api/interest-districts`, `PATCH /api/interest-districts/{interest_district_id}` (memo 수정), `DELETE /api/interest-districts/{interest_district_id}` — Clerk JWT 인증 필요 |
